...
describe('CheckoutSuccessPage', () => {
  ...
  describe('RED Phase - 테스트 실패 확인', () => {
    it('should render page component', async () => {
      // Import the client component instead of the async server component
      const { default: CheckoutSuccessContent } = await import(
        '@/app/(shop)/checkout/success/checkout-success-content'
      );
      ...
      render(<CheckoutSuccessContent searchParams={mockSearchParams} />);
